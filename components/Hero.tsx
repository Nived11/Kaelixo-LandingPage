      ...
      <section className="relative w-[min(1440px,92vw)] mx-auto z-10 flex flex-col justify-center min-h-[calc(100vh-76px)] py-4 sm:py-2 overflow-x-clip" id="home">
        <div className="grid grid-cols-1 xl:grid-cols-[46%_54%] items-center my-auto gap-6 xl:gap-0">
          <div className="pt-1 xl:pt-0">
            ...
            {/* Heading - Mobile view size increased slightly, desktop view completely untouched */}
            <h1 className="font-[800] text-[36px] sm:text-[40px] md:text-[clamp(36px,3.4vw,52px)] leading-[1.08] md:leading-[1.05] tracking-[-1px] md:tracking-[-2px] m-0 mb-[14px] max-w-[640px] font-[family-name:var(--font-space-grotesk),sans-serif]">
              ...
              and <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#3b82f6] via-[#f65cf4] to-[var(--pink)]">
            ...
            {/* Action Buttons */}
            <div className="flex gap-[18px] sm:gap-[20px] flex-wrap md:flex-nowrap">
              <Link 
                href="#" 
                onClick={(e) => {
                  e.preventDefault(); 
              ...
              >
                <span className="text-center md:text-left">BOOK FREE CONSULTATION</span> 
                
                {/* Book Free Consultation Icon (30x30 Size) */}
                <span className="w-[30px] h-[30px] border border-white/50 bg-transparent text-white flex items-center justify-center rounded-full text-[12px] shrink-0" style={{ fontWeight: 800 }}>
                  ↗
                </span>
              </Link>
              ...
              <Link 
                ...
                href="#services"
              >
                <span className="text-center md:text-left">EXPLORE OUR SERVICES</span> 
                
                {/* Explore Services Icon (Matched to 30x30 Size) */}
            ...
            {/* Stats Metrics Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-[10px] md:gap-2 mt-[50px] md:border-t md:border-[var(--line)] md:pt-[14px] max-w-none md:max-w-[600px]">
